...
*  - DepAnal.h, TypeAnal.h, TypeTable.h, strongComp.h
*
*  Maintanence History:
*  --------------------
*  ver 1.5 : 27 Feb 2016
...
namespace CodeAnalysis
{
  ...
  public:
	...
	void processSourceCodecppHeader(bool showActivity);
	void processSourceCodecppImplemFile(bool showActivity);
	void processSourceCodecsharp(bool showActivity);
